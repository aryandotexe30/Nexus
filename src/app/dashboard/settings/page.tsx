      ...
      <div className="space-y-8">
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 bg-blue-50 dark:bg-blue-900/20 rounded-2xl border border-blue-200 dark:border-blue-800">
            <div>
              <h3 className="font-bold text-blue-900 dark:text-blue-100">Customer Care</h3>
              <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">Need help? Open a live chat ticket with an administrator.</p>
            </div>
            <a href="/dashboard/support" className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg transition-colors shadow-lg shadow-blue-500/30">
              Start Support Chat
            </a>
          </div>
        </motion.section>
